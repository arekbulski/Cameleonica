...
Project is "under construction". Design documentation is the main focus right now, and there will be no code to back for now. Gedunken experiments is what is being run. I highly recommend reading:
...
Referenced documentation is a local copy of published articles. All bibliography entries (and few unmentioned) are there. There are also some random notes, few wallpapers, and other junk you can ignore.
...
Easiest way for you to submit anything is to create a new Issue or Pull Request. If you want to ask a question or suggest some idea, just open an Issue and post your thing. I will take over from there.
